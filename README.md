...
Raspberry Pi 3B with sensors MH-Z19 (CO2, using a FT232R xserial UART interface), ADT7420 (accurate indoor temperature), BME280 (atmospheric pressure and humidity) using a I2C bus PCB, which provides pullup resistors and connectors.
