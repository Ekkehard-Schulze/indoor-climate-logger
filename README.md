...
- on a PC you need one of the supported I2C to USB interfaces and you need to use the -u ... option to select the device. 1-Wire is not supported on MS-Windows. 
